 ...
 * @author hongfeng.li
 * @version 1.0
 * @title ConcurrentReferenceHashMap
 * @desc 软引用HashMap
 * @since 2021年02月05日
 */
public class ConcurrentReferenceHashMap<K, V> extends AbstractMap<K, V> implements ConcurrentMap<K, V> {
    ...
    /**
     * Get the hash for a given object, apply an additional hash function to reduce collisions. This implementation uses
     * the same Wang/Jenkins algorithm as {@link ConcurrentHashMap}. Subclasses can override to provide alternative
     * hashing.
     *
     ...
     * garbage collected entries are automatically purged as items are added or removed from the Map. This method can be
     * used to force a purge, and is useful when the Map is read frequently but updated less often.
     */
    ...
    /**
     * Calculate a shift value that can be used to create a power-of-two value between the specified maximum and minimum
     * values.
     *
    ...
    protected final class Segment extends ReentrantLock {
        ...
        /**
         * Restructure the underlying data structure when it becomes necessary. This method can increase the size of the
     ...
     * reference implementations (e.g., {@link SoftReference}).
     */
    ...
    /**
     * Strategy class used to manage {@link Reference}s. This class can be overridden if alternative reference types
    ...
    protected class ReferenceManager {
         ...
         * {@code null} if no references need purging. This method must be thread safe and ideally should not block when
         * returning {@code null}. References should be returned once and only once.
         *
